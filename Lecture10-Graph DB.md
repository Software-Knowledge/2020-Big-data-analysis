...
| ![](img/lec10/1.png) | ![](img/lec10/2.png) |
| -------------------- | -------------------- |
| ![](img/lec10/3.png) | ![](img/lec10/4.png) |
| ![](img/lec10/5.png) | ![](img/lec10/6.png) |
| ![](img/lec10/7.png) |                      |
...
## 2.1. 什么是Neo4j
1. 由Neo Technologies开发
2. 最受欢迎的图形数据库
3. 用Java实现
4. 开源
5. 面向图
6. 以Java实施，可通过交易HTTP端点使用Cypher查询语言从其他语言编写的软件中访问。
7. 符合ACID的事务数据库，具有本机图存储和处理功能。
8. 最受欢迎的图形数据库。
9. 一切都存储为边，节点或属性。
10. 每个节点和边缘可以具有任意数量的属性。
11. 节点和边均可标记。
12. 标签可用于缩小搜索范围
...
2. 对图数据库的OLAP支持不够完善，该领域正在发生大量研究
...
| ![](img/lec10/13.png) | ![](img/lec10/14.png) |
| --------------------- | --------------------- |
| ![](img/lec10/15.png) |                       |
