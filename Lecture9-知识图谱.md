...
## 10.12. 基于统计的问句解析
1. 思想
   1. 对于跨领域实体时，需要借助统计信息完成实体链接和意图分类
   2. Eg:我要去看花千骨的免费版
...
2. 过程
   1. (question classification)，语义匹配与答案选择(answer selection)，答案自动生成
   2. (answer generation);即对用户输入解析、答案查询与检索等环节进行优化。
