...
4. MapReduce框架提供了一组完整的供程序员开发MapReduce应用程序的编程接口。
...
$$
P(B_i|A) = \frac{P(B_i)P(A|B_i)}{\sum\limits_{j=1}\limits^nP(B_i)P(A|B_j)}
$$
